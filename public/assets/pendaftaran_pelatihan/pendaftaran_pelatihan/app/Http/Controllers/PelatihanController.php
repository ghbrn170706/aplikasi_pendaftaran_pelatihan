...
class PelatihanController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('foto_pelatihan')) {
            ...
            $pelatihan->foto_pelatihan = $request->file('foto_pelatihan')->store('pelatihan', 'public');
        }

        if ($request->hasFile('gambar_pelatihan')) {
            Storage::delete('public/' . $pelatihan->gambar_pelatihan);
            $pelatihan->gambar_pelatihan = $request->file('gambar_pelatihan')->store('pelatihan', 'public');
        }
