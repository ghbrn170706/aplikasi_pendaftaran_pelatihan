...
<head>
    ...
    <title>Edit Kejuruan</title>
    <!-- Tailwind CSS CDN -->
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body>
<div class="container mx-auto p-6 bg-gray-100">
    <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Edit Kejuruan</h1>
    ...
    <!-- Form Edit Kejuruan -->
    <form action="{{ route('kejuruan.update', $kejuruan->kejuaruanID) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_kejuruan" id="nama_kejuruan" value="{{ old('nama_kejuruan', $kejuruan->nama_kejuruan) }}"
        ...
        <div class="mb-4">
            ...
            @if ($kejuruan->gambar)
                <div class="mt-2">
                    <img src="{{ asset('storage/' . $kejuruan->gambar) }}" alt="Gambar Kejuruan" class="w-32 h-32 object-cover rounded-md">
                </div>
            @endif
        </div>
