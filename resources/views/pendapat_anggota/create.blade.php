...
<div class="container mx-auto p-6 bg-gray-100">
    <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Tambah Testimoni Anggota</h1>
    ...
    <form action="{{ route('pendapat_anggota.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_anggota" id="nama_anggota" value="{{ old('nama_anggota') }}"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="posisi_sebagai" id="posisi_sebagai" value="{{ old('posisi_sebagai') }}"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="jabatan_pekerjaan" id="jabatan_pekerjaan" value="{{ old('jabatan_pekerjaan') }}"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                required>
...
<div class="mb-4">
    ...
    <textarea name="gols" id="gols" rows="3"
        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('gols') }}</textarea>
    @error('gols')
        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
    @enderror
</div>
...
<div class="mb-4">
    ...
    <textarea name="perjalanan_karir" id="perjalanan_karir" rows="4"
        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('perjalanan_karir') }}</textarea>
